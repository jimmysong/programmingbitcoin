...
Bare Multisig((("multisig (multiple signatures)", "Bare Multisig"))) was the first attempt at creating transaction outputs that require signatures from multiple parties.
