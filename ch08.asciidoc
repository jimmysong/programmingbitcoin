...
`OP_m` will((("OP_m operation")))((("OP_n operation"))) push the number _m_ to the stack, the public keys will be pushed to the stack, and `OP_n` will push the number _n_ to the stack (<<bare_multisig_step_3>>).
