...
Pay-to-script-hash (p2sh)((("p2sh (pay-to-script-hash)", "operation of", id="p2shoper08")))((("multisig (multiple signatures)", "p2sh (pay-to-script-hash) operation", id="MSp2shoper08"))) is a general solution to the long address/ScriptPubKey problem.
...
We've verified one of the two signatures that are required to unlock this p2sh multisig.((("", startref="p2shsignver08")))((("", startref="MSp2shcode08")))
