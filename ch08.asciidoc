...
.`OP_EVAL` would have been an instruction that adds additional instructions based on the top element
...
We're checking that the next three instructions conform to the BIP0016 special pattern.
