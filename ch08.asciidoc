...
images::multisig1.png[Bare Multisig ScriptPubKey]
...
images::multisig2.png[Bare Multisig ScriptSig]
...
images::multisig3.png[Bare Multisig Combination]
...
images::multisig4.png[Bare Multisig Start]

OP_0 will place a 0 on the stack.

images::multisig5.png[Bare Multisig Step 1]

The signatures are elements so they'll go straight to the stack.

images::multisig6.png[Bare Multisig Step 2]
...
images::multisig7.png[Bare Multisig Step 3]
...
images::multisig8.png[Bare Multisig End]
...
images::p2sh2.png[p2sh RedeemScript]
...
images::p2sh3.png[p2sh ScriptPubKey]
...
images::p2sh4.png[p2sh ScriptSig]

This produces the Script:

images::p2sh5.png[p2sh Combination]
...
We've learned how p2sh works and how it's much easier to use, despite its clunkiness. We now turn to Blocks.