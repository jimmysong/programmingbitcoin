...
We've generalized here so we can see what a m-of-n multisig would look like (m and n can be anything from 1 to 75). Note the OP_0 at the top. The script stack, then starts like this:
