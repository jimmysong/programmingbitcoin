...
p2wsh is particularly important, as unmalleable multisig transactions are required for creating bidirectional Payment Channels for the Lightning Network.((("", startref="Spaywithash13")))((("", startref="p2witscripthash13")))
...
<6> Parse the WitnessScript and add to the command set.
