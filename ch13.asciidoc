...
p2wpkh((("Segwit (segregated witness)", "p2sh-p2wpkh", id="Sp2sh13")))((("p2sh (pay-to-script-hash)", "backward compatibility", id="p2shback13"))) is great, but unfortunately, this is a new type of Script and older wallets cannot send Bitcoins to p2wpkh ScriptPubKeys.
...
We make a p2pkh combined Script from the 20-byte hash, signature and pubkey and evaluate.((("", startref="p2wpkh13")))
