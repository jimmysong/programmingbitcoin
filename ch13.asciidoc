...
_Transaction malleability_ is the((("transaction malleability")))((("Segwit (segregated witness)", "transaction malleability"))) ability to change the transaction's ID without altering the transaction's meaning.
