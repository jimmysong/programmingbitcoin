...
Sequence((("high-frequency trades"))) was originally intended as a way to do what Satoshi called "high-frequency trades" with the Locktime field (see _Sequence and Locktime_), but is currently used with Replace-By-Fee and `OP_CHECKSEQUENCEVERIFY`.
