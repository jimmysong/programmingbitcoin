...
Note that the transaction fee is not specified anywhere! This is because the fee is an implied amount.
...
We've covered exactly how to parse and serialize transactions along with what most of the fields mean.
