...
Given((("Merkle Trees", "parent hashes")))((("Merkle Parent Level"))) two hashes, we produce another hash that represents both of them.
...
Given an ordered list of more than two hashes, we can calculate the parents of each pair, or what we call the _Merkle Parent Level_.
