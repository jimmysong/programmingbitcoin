...
The((("Merkle Blocks", "flag bits and hashes", id="MBflag11")))((("flag bits")))((("hashes", "using in Merkle Blocks", id="Hblock11"))) flag bits inform where the hashes go using depth-first ordering.
...
<13> All flag bits must be consumed or we got bad data.((("", startref="Bmerkel11")))
