...
Pay-to-pubkey-hash (p2pkh) is((("ScriptPubKeys", "p2pkh (pay-to-pubkey-hash)", id="Hp2pkh06")))((("p2pkh (pay-to-pubkey-hash)", id="p2pkh06")))((("p2pk (pay-to-pubkey)", "solving problems with p2pkh"))) an alternative script format that has two key advantages over p2pk:
