...
To((("Bitcoin", "downloading and installation")))((("example code", "environment setup"))) get the most out of this book, you'll want to create an environment where you can run the example code and do the exercises.
