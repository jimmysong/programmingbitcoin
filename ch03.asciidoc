...
We know from Point Addition that A+(B+C)=(A+B)+C (see Figure pass:[<a data-type="xref" data-xrefstyle="select:labelnumber" href="#a_b_c_case_1">#a_b_c_case_1</a> and <a data-type="xref" data-xrefstyle="select:labelnumber"href="#a_b_c_case_2">#a_b_c_case_2</a>])
