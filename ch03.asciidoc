...
Because((("scalar multiplicaiton", "for elliptic curves", id="SMelliptic03")))((("Elliptic Curve Cryptography", "scalar multiplication for elliptic curves", id="ECCscalar03"))) we can add a point to itself, we can introduce some new notation:
...
This((("Discrete Log problem"))) is called the Discrete Log problem and is the basis of Elliptic Curve Cryptography.
...
What we actually want to generate for the purposes of Public Key Cryptography are((("Finite Cyclic Groups"))) Finite Cyclic Groups, and it turns out that if we take a Generator Point from an Elliptic Curve over a Finite Field, we can generate a Finite Cyclic Group.
