...
This((("closure")))((("Finite Cyclic Groups", "closure property"))) is perhaps the easiest to prove since we generated the group in the first place by adding G over and over.
...
Invertibility((("invertibility")))((("Finite Cyclic Groups", "invertibility"))) is easy to depict (<<each_point_is_invertible_by_taking_the_reflection_over_the_x_axis>>).
