...
This((("Bitcoin", "overview of components")))((("Elliptic Curve Cryptography", "role in Bicoin")))((("signing and verification", "purpose of")))((("Transactions", "role in Bitcoin"))) chapter is going to get you off to a more manageable start.
...
By learning Finite Fields((("Finite Fields", "role in Bitcoin")))((("Elliptic Curves", "role in Bitcoin"))) and Elliptic Curves first, you'll get a firm grasp of concepts that you'll need to progress logically.
