...
****
There's are many proofs of this theorem, but perhaps the simplest is utilizing what we saw in the exercise above. Namely that the sets:
...
The (p-1)! on both sidse cancel giving us:
...
The other fact that we have to wrap around is that division is really multiplication with the inverse. Thus:
