...
We((("&#x005F;&#x005F;pow&#x005F;&#x005F; method"))) method need to define the exponentiation for `FieldElement`, which in Python can be defined with the `__pow__` method, overriding the `**` operator.
