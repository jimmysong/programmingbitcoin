...
One((("&#x005F;&#x005F;pow&#x005F;&#x005F; method"))) last thing that we need to take care of before we leave this chapter is the `__pow__` method, which needs to handle negative exponents.
