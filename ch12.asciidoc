...
There((("Bloom Filters", "getting Merkle Blocks")))((("Merkle Blocks", "filtered"))) is one more command that a light client needs: Merkle Block information about transactions of interest from the full node.
