...
Thus, if _y_ is even, _p_ – _y_ (odd minus even) will be odd.
...
++++
<ul class="simplelist">
<li>Find <em>w</em> such that <em>w</em><sup>2</sup> = _v_ when we know <em>v</em>.</li>
</ul>
++++
...
<3> We take the square root of the right side of the Elliptic Curve equation to get the _y_.
