...
Another((("serialization", "DER format")))((("Signature class", "serialization of")))((("DER format")))((("signing and verification", "serializing signature"))) class that we need to learn to serialize is `Signature`.
