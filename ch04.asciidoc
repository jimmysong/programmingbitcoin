...
Another((("serialization", "DER Signature format")))((("Signature class", "serialization of")))((("DER Signature format")))((("signing and verification", "serializing signature"))) class that we need to learn to serialize is `Signature`.
