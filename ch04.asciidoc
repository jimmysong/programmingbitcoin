...
In((("serialization", "Base58")))((("Base58"))) the early days of Bitcoin, Bitcoins were assigned to public keys specified in SEC format (uncompressed) and then were redeemed using DER signatures.
...
This((("Base64"))) construction is called Base58.
