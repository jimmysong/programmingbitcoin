...
Now((("Elliptic Curves", "Point Addition for  &#x22260; , id="ECxnotequal02")))((("Point Addition", "for &#x22260; ", id="PAxnotequal02")))((("slope"))) that we've covered the vertical line, let's examine when the points are different.
