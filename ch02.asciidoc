...
----
<1> If the two points are equal and the _y_ coordinate is 0, we return the point at infinity.((("", startref="MTeliptic02")))((("", startref="ECpoindcode02")))((("", startref="PAcode02")))
