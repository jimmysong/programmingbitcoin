...
Now((("Elliptic Curves", "Point Addition for  , id="ECxnotequal02")))((("Point Addition", "for  ", id="PAxnotequal02")))((("slope"))) that we've covered the vertical line, let's examine when the points are different.
