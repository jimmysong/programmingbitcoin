...
Now((("Elliptic Curves", "Point Addition for x&#x2081 &#x22260; x&#x2082;")))((("Point Addition", "for x&#x2081 &#x22260; x&#x2082;"))) that we've covered the vertical line, let's examine when the points are different.
