...
First, we have to adjust((("&#x005F;&#x005F;init&#x005F;&#x005F; method)))" the `__init__` method slightly so it doesn't check that the curve equation is satisfied when we have the point at infinity.
Second, we((("&#x005F;&#x005F;add&#x005F;&#x005F; method"))) have to overload the addition operator or `__add__` as we did with the `FieldElement` class.
