...
[.lead]
In this chapter we're going to learn about Elliptic Curves. In the next chapter, we'll be combining Elliptic Curves with Finite Fields to make Elliptic Curve Cryptography.
