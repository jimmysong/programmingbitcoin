...
Now((("Elliptic Curves", "Point Addition for x&#x2081 &#x22260; x&#x2082;")))((("Point Addition", "for x&#x2081 &#x22260; x&#x2082;")))((("slope"))) that we've covered the vertical line, let's examine when the points are different.
...
Remember that __y__~3~ is the reflection over the x-axis.((("Point Addition", "deriving the Point Addition Formula")))
