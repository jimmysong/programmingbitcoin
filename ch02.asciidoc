...
When((("Elliptic Curves", "Point Addition for ", id="Pequal02")))((("Point Addition", "for ", id="PAPequal02"))) the `x` coordinates are the same and the `y` coordinate is different, we have the situation where the points are opposite each other over the x-axis.
