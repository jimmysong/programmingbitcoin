...
We((("Elliptic Curves", "Point Addition coding", id="ECpointcode02")))((("Point Addition", "coding", id="PAcode02"))) first handle the identity, or the point at infinity.
...
Now((("slope"))) that we've covered the vertical line, let's examine when the points are different.
...
At((("self.__class__ method"))) the end of the method, we return an instance of the class `Point` using `self.__class__` to make subclassing easier.
...
----
<1> If the two points are equal and the _y_ coordinate is zero, we return the point at infinity.((("", startref="ECpointcode02")))((("", startref="PAcode02")))
