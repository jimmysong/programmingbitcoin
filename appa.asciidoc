...
class FieldElement:
...
include::code-ch01/answers.py[tag=exercise1,indent=4]
----
...
class FieldElement:
...
include::code-ch01/answers.py[tag=exercise3,indent=4]
----
...
class FieldElement:
...
include::code-ch01/answers.py[tag=exercise6,indent=4]
----

include::code-ch01/exercises.asciidoc[tag=exercise7]
...
include::code-ch01/exercises.asciidoc[tag=exercise8]
...
include::code-ch01/exercises.asciidoc[tag=exercise9]

[source,python]
----
class FieldElement:
...
include::code-ch01/answers.py[tag=exercise9,indent=4]
----

=== <<chapter_elliptic_curves>>: Elliptic Curves

include::code-ch02/exercises.asciidoc[tag=exercise1]
...
include::code-ch02/exercises.asciidoc[tag=exercise2]
...
include::code-ch02/exercises.asciidoc[tag=exercise3]
...
include::code-ch02/exercises.asciidoc[tag=exercise4]
...
include::code-ch02/exercises.asciidoc[tag=exercise5]
...
include::code-ch02/exercises.asciidoc[tag=exercise6]
...
include::code-ch02/exercises.asciidoc[tag=exercise7]
...
include::code-ch03/exercises.asciidoc[tag=exercise1]
...
include::code-ch03/exercises.asciidoc[tag=exercise2]
...
include::code-ch03/exercises.asciidoc[tag=exercise3]
...
include::code-ch03/exercises.asciidoc[tag=exercise4]
...
include::code-ch03/exercises.asciidoc[tag=exercise5]
...
include::code-ch03/exercises.asciidoc[tag=exercise6]
...
include::code-ch03/exercises.asciidoc[tag=exercise7]
...
>>> sig = Signature(r,s)
>>> print(sig.der().hex())
3045022037206a0610995c58074999cb9767b87af4c4978db68c06e8e6e81d282047a7c60221008ca63759c1157ebe
aec0d03cecca119fc9a75bf8e6d0fa65c841c8e2738cdaec
----
