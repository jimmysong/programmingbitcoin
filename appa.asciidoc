...
----
<1> `collision1` and `collision2` are from the SHA-1 preimages that https://security.googleblog.com/2017/02/announcing-first-sha1-collision.html[Google found to collide].
