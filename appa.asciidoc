...
class Point:
...
include::code-ch02/answers.py[tag=exercise2,indent=4]
----
...
class Point:
...
include::code-ch02/answers.py[tag=exercise3,indent=4]
----
...
...
    ...
    ...
include::code-ch02/answers.py[tag=exercise5,indent=4]
----
...
...
    def __add__(self, other):
    ...
include::code-ch02/answers.py[tag=exercise7,indent=4]
----
...
...
include::code-ch03/answers.py[tag=answer3,indent=4]
----
