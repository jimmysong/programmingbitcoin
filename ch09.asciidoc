...
BIP91((("BIP (Bitcoin Improvement Proposals)", "BIP91"))) used something like BIP9 but with an 80% threshold and a smaller block period, so it wasn't strictly using BIP9.
