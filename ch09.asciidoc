...
Soft forks that used BIP9 as of this writing have been BIP68/BIP112/BIP113 (`OP_CHECKSEQUENCEVERIFY` and related changes) and BIP141 (Segwit).
These BIPs used bits 0 and 1 for signaling, respectively.
BIP91 used something like BIP9, but used an 80% threshold and a smaller block period, so wasn't strictly using BIP9.
