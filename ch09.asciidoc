...
_Version_ in normal((("Blocks", "versions"))) software refers to a particular set of features.
...
Version 4 meant that the software was ready for((("BIP (Bitcoin Improvement Proposals)", "BIP0065"))) BIP0065, which specified `OP_CHECKLOCKTIMEVERIFY`.
