...
The((("Blocks", "timestamps")))((("timestamps"))) timestamp is a UNIX-style timestamp taking up 4 bytes.
...
The((("BIP (Bitcoin Improvement Proposals)", "BIP113"))) Locktimes were at one point used directly for transactions within a block, but BIP113 changed the behavior to not use the current block's Locktime directly, but the median-time-past (MTP) of the past 11 blocks.
