...
To prevent double-spending, a node checks that each input exists and has not been spent.
...
Nodes also make sure that the sum of the inputs is greater than or equal to the sum of the outputs.
...
This was particularly obvious with the biggest transaction mined to date:&#x2060; pass:[<code>bb41a757f405890fb0f5856228e23b715702d714d59bf2b1feb70&#x200b;d8b2b4e3e08</code>].
