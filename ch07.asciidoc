...
Each input points to a previous transaction output, which has a ScriptPubKey. Recall the diagram from <<chapter_script>> shown in <<scriptpubkey_and_scriptsig>>.
