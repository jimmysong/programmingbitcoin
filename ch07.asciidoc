...
Signing((("signing and verification", "signing process", id="SAVsign07")))((("Transactions", "signing", id="Tsign07"))) the transaction would be tricky, but we know how to get the signature hash, or `z`, from earlier in this chapter.
...
This is a big accomplishment for a budding Bitcoin developer, so please take some time to complete this exercise.((("", startref="Tsign07")))((("", startref="SAVsign07")))
