...
[WARNING]
====
Back((("addresses, reusing"))) in <<chapter_script>>, we went through how p2pk was inferior to p2pkh, in part because it was only protected by ECDSA.
...
That((("Discrete Log problem"))) said, as of this writing, we are still protected by the Discrete Log problem, which is unlikely to be broken any time soon.
